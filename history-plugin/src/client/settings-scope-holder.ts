/**
 * Where the bound `session-history` settings scope lives once the service is
 * available.
 *
...
let current: SettingsScope<HistoryConfig> | undefined
 ...
 */
export function publishScope(scope: SettingsScope<HistoryConfig>): void {
  current = scope
 ...
 */
export function readScope(): SettingsScope<HistoryConfig> | undefined {
  return current
}
